...
def main(location_names):
  ...
  for location_criterion in location_criteria:
    #parent_string = ''
    if (location_criterion['location']['locationName'] in location_names):
        print(location_criterion['location']['locationName'])
        location_id.append(location_criterion['location']['id'])
